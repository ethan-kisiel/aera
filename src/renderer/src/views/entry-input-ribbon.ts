...
export class EntryInputRibbon extends LitElement {
      ...
      <form class="ribbon" @submit=${this._handleSubmit}>
        ...
        <div class="fields">
          ...
          <div class="field notes-field">
            ...
            <notes-input .value=${this.entry.notes} @input=${this._handleNotesInput}></notes-input>
          </div>
        </div>

        <div class="actions">
          <button class="save-button" type="submit" ?disabled=${this.disabled}>Save</button>
        </div>
      </form>
    `
  }
  ...
  static override styles = css`
    ...
    input:hover {
      border-color: var(--color-border-hover, #98a2b3);
    }
    ...
    .close-button:hover {
      border-color: var(--color-danger-border, #fecdca);

      background: var(--color-danger-surface, #fef3f2);

      color: var(--color-danger, #d92d20);
    }

    .close-button:focus-visible {
      outline: 2px solid var(--color-danger, #d92d20);
