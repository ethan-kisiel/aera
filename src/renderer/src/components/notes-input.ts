...
export class NotesInput extends LitElement {
  ...
  protected render(): TemplateResult {
    ...
    const atLimit = this.maxLength > 0 && characterCount >= this.maxLength
    ...
    return html`
      <div class="container">
        <textarea
          ...
          maxlength=${this.maxLength > 0 ? this.maxLength : 500}
        ...
        <span id="character-count" class=${atLimit ? 'character-count limit' : 'character-count'}>
