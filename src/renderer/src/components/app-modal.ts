...
export class AppModal extends LitElement {
    ...
    protected override render() {
        ...
        return html`
            <div
                class="backdrop"
                @mousedown=${this._handleBackdropMouseDown}
            >
                <section
                    class="modal"
                    role="dialog"
    ...
    private _handleAction(action: ModalAction) {
        this.dispatchEvent(
    ...
    private _handleBackdropMouseDown(event: MouseEvent) {
        if (
